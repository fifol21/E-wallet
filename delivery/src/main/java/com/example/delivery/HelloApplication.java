...
public class HelloApplication extends Application {
    ...
    public static void createOrder(String customerPhoneNumber, String name, String address,String status, String destination, String size, float weight, boolean ifFragile, CustomerDAO customerDAO,PackageDAO packageDAO,OrderDAO orderDAO, VehicleDAO vehicleDAO) {
        int customerID;
        int orderID;
        int vehicleID;
        float cost;
